...
0x3n0_dialog() {
    DIALOG_RESULT=$(dialog --clear --stdout --backtitle "0x3n0" --no-shadow "$@" 2>/dev/null)
}

#################
#### Welcome ####
#################
0x3n0_dialog --title "Welcome" --msgbox "Welcome to 0x3n0.\n" 6 60
...
0x3n0_dialog --title "UEFI or BIOS" --radiolist "${UEFI_BIOS_text}\nPress <Enter> to accept." 10 30 2 1 UEFI "$UEFI_radio" 2 BIOS "$BIOS_radio"
[[ $DIALOG_RESULT -eq 1 ]] && UEFI=1 || UEFI=0

#################
#### Prompts ####
#################
0x3n0_dialog --title "Hostname" --inputbox "Please enter a name for this host.\n" 8 60
hostname="$DIALOG_RESULT"

##########################
#### Password prompts ####
##########################
0x3n0_dialog --title "Disk encryption" --passwordbox "Please enter a strong passphrase for the full disk encryption.\n" 8 60
encryption_passphrase="$DIALOG_RESULT"

0x3n0_dialog --title "Root password" --passwordbox "Please enter a strong password for the root user.\n" 8 60
root_password="$DIALOG_RESULT"

#################
#### Warning ####
#################
0x3n0_dialog --title "WARNING" --msgbox "This script will NUKE /dev/sda from orbit.\nPress <Enter> to continue or <Esc> to cancel.\n" 6 60
[[ $? -ne 0 ]] && (0x3n0_dialog --title "Cancelled" --msgbox "Script was cancelled at your request." 5 40; exit 0)
